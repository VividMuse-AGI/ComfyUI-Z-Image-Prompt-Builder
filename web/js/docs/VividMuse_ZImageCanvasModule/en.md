...
MP and Divisible By are always visible in Canvas; click the preview row only for legacy compatibility modes. Old workflows keep their original dimensions or MP calculation until you edit Megapixels; changing the divisor on an old fixed-size node also enables calculation. Old budgets in ten-thousand-pixel units display as MP automatically (300 becomes 3 MP) without changing the saved size.
